...
class Test_Automation:
    @allure.title("#Test_Case -8")
    @allure.description("Booking the HongKong country appointment with direct date option and not "
                        "providing any health issues")
    @allure.tag("Integration", "#1", "TestCase")
    @allure.label("Owner", "Mohammad_Zain")
    @allure.testcase("Integration_Testing_8")
